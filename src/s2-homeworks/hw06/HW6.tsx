...
const HW6 = () => {
    ...
    const restore = () => {
        // делают студенты
        const savedValue = restoreState<string>('hw6-editable-span-value', ''); // Восстанавливаем значение из localStorage
        setValue(savedValue); // Устанавливаем восстановленное значение в состояние
    }
